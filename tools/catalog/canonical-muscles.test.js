...
const tsSourcePath = path.join(__dirname, '..', '..', 'apps', 'mobile', 'src', 'constants', 'muscles.ts');
...
assert.deepEqual(
  MUSCLE_IDS,
  tsMuscleIds,
  'tools/catalog/canonical-muscles.js is out of sync with constants/muscles.ts'
);
