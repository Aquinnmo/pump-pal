...
import { manifestQuery } from '../../shared/api-contract.js';
import { ApiError, withRoute } from '../_lib/http.js';
import { getManifest } from '../_lib/store/sync.js';
 ...
 */
export default withRoute(['GET'], async (req: VercelRequest, res: VercelResponse, { uid }) => {
