...
## Corpus Check
- 151 files · ~107,502 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1211 nodes · 2176 edges · 132 communities (57 shown, 75 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 55 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `97135d32`
...
Cohesion: 0.06
Nodes (95): ActiveWorkoutScreen(), formatElapsed(), styles, WorkoutTimer(), AddWorkoutModal(), styles, PlannedWorkoutsScreen(), queueOrderCacheKey() (+87 more)
