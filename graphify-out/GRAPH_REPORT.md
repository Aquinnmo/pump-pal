...
## Corpus Check
- 200 files · ~123,187 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1508 nodes · 2842 edges · 161 communities (84 shown, 77 thin omitted)
...
1. `useAuth()` - 43 edges
2. `ActiveWorkoutScreen()` - 32 edges
3. `Workout` - 31 edges
...
- `AddWorkoutModal()` --indirect_call--> `collapseSetsToDraft()`  [INFERRED]
  app/modal.tsx → utils/workout-conversion.ts
- `SettingsAccountScreen()` --calls--> `useAuth()`  [EXTRACTED]
  app/settings-account.tsx → context/auth-context.tsx
...
Cohesion: 0.07
Nodes (39): buildTimeline(), ChallengeData, ChallengeDay, currentStreakLength(), formatDate(), formatTime(), isStreakAlive(), PushupChallengeScreen() (+31 more)
...
Cohesion: 0.10
Nodes (36): askChoice(), askMuscles(), askTrackingModes(), askVariation(), buildVariation(), createPrompt(), DEFAULT_CATALOG_PATH, documentId() (+28 more)

### Community 14 - "useAuth"
Cohesion: 0.15
Nodes (13): DevelopmentProgressScreen(), styles, SettingsScreen(), styles, styles, UpNextScreen(), FadingScrollView(), FadingScrollViewProps (+5 more)

### Community 15 - "planned-workouts.tsx"
Cohesion: 0.20
Nodes (13): PlannedWorkoutsScreen(), queueOrderCacheKey(), styles, SetSplitScreen(), styles, SettingsSplitScreen(), styles, Dropdown() (+5 more)
...
Cohesion: 0.17
Nodes (23): auth, liveUpdateNotificationActionTask(), actionQueue, applySetAction(), applyWorkoutAction(), finishWorkout(), handleWearAction, handleWorkoutAction() (+15 more)
...
### Community 27 - "muscle-map.tsx"
Cohesion: 0.18
Nodes (16): MUSCLE_OPTIONS, MuscleMap(), MuscleMapProps, styles, BODY_SILHOUETTES, MUSCLE_PEBBLES, BodySilhouette, MUSCLE_MAP_VIEWBOX (+8 more)
...
Cohesion: 0.18
Nodes (18): base64url(), createJwt(), crypto, docId(), fieldsToJs(), firestoreValueToJs(), fs, getAccessToken() (+10 more)
...
### Community 71 - "components/development-progress.tsx"
Cohesion: 0.16
Nodes (18): DevelopmentProgress(), formatChange(), selectedAccessibility(), statusFor(), styles, GRADIENT_COLORS, MuscleMapLegend(), MuscleMapLegendProps (+10 more)
...
Cohesion: 0.17
Nodes (26): buildMappings(), ComparableSignal, computeMuscleDevelopment(), makeMapping(), mappingKey(), MUSCLE_DEVELOPMENT_WINDOW_DAYS, MuscleDevelopmentContributor, MuscleDevelopmentCoverage (+18 more)

### Community 77 - "wear-state.ts"
Cohesion: 0.08
Nodes (24): DraftExerciseRow, applyWearAction(), FlatSet, flattenSets(), mapRow(), allDone, bumped, bw (+16 more)
...
Cohesion: 0.13
Nodes (12): LiveUpdateNotificationPayload, LiveUpdateSegment, dismiss(), isSupported(), LiveUpdateNotificationNativeModule, nativeModule, show(), subscribeActions() (+4 more)
...
Cohesion: 0.11
Nodes (24): DragHandle(), styles, compareExerciseLabels(), ExercisePicker(), ExercisePickerProps, ExercisePickerSelection, Sheet, SheetHandle (+16 more)
...
Cohesion: 0.11
Nodes (35): ActiveWorkoutScreen(), formatElapsed(), styles, WorkoutTimer(), RootLayoutNav(), unstable_settings, AddWorkoutModal(), styles (+27 more)

### Community 99 - "muscle-load.ts"
Cohesion: 0.16
Nodes (26): baselineKey(), buildMappings(), computeMuscleLoad(), contributorKey(), makeMapping(), mappingKey(), MUSCLE_LOAD_HALF_LIFE_DAYS, MUSCLE_LOAD_SATURATION_SCORE (+18 more)

### Community 100 - "exercise-catalog.ts"
Cohesion: 0.14
Nodes (19): MuscleLoadScreen(), styles, AnalyticsNavigationRow(), AnalyticsNavigationRowProps, styles, DevelopmentProgressSummary(), DevelopmentProgressSummaryProps, styles (+11 more)

### Community 103 - "workout-notification-model.ts"
Cohesion: 0.12
Nodes (20): DraftSet, nextSetIndex(), buildWorkoutNotificationPresentation(), currentSetDetail(), FlatSet, flattenSets(), formatDuration(), nonblankRows() (+12 more)

### Community 110 - "workout-conversion.ts"
Cohesion: 0.20
Nodes (18): styles, WorkoutsScreen(), DevelopmentProgressProps, Props, styles, WorkoutCard(), WorkoutCardProps, Workout (+10 more)

### Community 114 - "dry-run-conversion.js"
Cohesion: 0.15
...
### Community 121 - "toDateObj"
Cohesion: 0.25
Nodes (14): HomeScreen(), styles, db, firebaseConfig, applyInjuryToHistory(), injuryCoversDate(), predictNextWorkoutName(), predictWorkoutAfterName() (+6 more)

### Community 129 - "MuscleId"
Cohesion: 0.21
Nodes (15): MuscleLoadMap(), MuscleLoadMapProps, relativeDate(), selectedAccessibility(), statusFor(), styles, MuscleId, muscleLabel() (+7 more)

### Community 131 - "WearMessageService"
Cohesion: 0.40
Nodes (3): MessageEvent, WearMessageService, WearableListenerService

### Community 132 - "expo-router"
Cohesion: 0.25
Nodes (5): plugins, Props, expo-localization, expo-router, expo-web-browser

### Community 134 - "settings-app.tsx"
Cohesion: 0.20
Nodes (9): updates, SettingsAccountScreen(), styles, SettingsAppScreen(), styles, url, styles, Toast() (+1 more)

### Community 135 - "muscle-analysis.ts"
Cohesion: 0.29
Nodes (10): isMuscleId(), MUSCLE_REGIONS, MUSCLE_SET, analyzeMuscles(), computeMuscleVolume(), muscleInsightsSchema, MuscleVolumeStat, normalizeInsightList() (+2 more)

### Community 136 - "phone-auth.tsx"
Cohesion: 0.24
...
Cohesion: 0.14
Nodes (11): addExerciseToCatalog(), buildApprovedExercise(), {
  ...
  parseCommaList,
  timestampMillis,
}, approvedExercise, assert, candidate, catalog, documents (+3 more)

### Community 138 - "analytics.tsx"
Cohesion: 0.24
...
### Community 152 - "widget-up-next.tsx"
Cohesion: 0.42
Nodes (5): readWidgetUpNext(), WIDGET_UP_NEXT_FALLBACK, WidgetUpNext, UpNextWidget(), widgetTaskHandler()
...
### Community 155 - "Canonical Collections"
Cohesion: 0.25
...
### Community 156 - "wear-sync.android.ts"
Cohesion: 0.36
Nodes (3): WearSyncNativeModule, KNOWN, subscribeWearActions()

### Community 158 - "describeUpNext"
Cohesion: 0.50
Nodes (3): describeUpNext(), UpNextCopy, UpNextState

### Community 160 - "Pump Pal Data Model"
Cohesion: 0.67
Nodes (3): Collections, Conventions used throughout, Pump Pal Data Model

## Knowledge Gaps
- **578 isolated node(s):** `name`, `slug`, `version`, `orientation`, `icon` (+573 more)
