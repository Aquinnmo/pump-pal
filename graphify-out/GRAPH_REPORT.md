# Graph Report - pump-pal  (2026-08-01)

## Corpus Check
- 135 files · ~82,809 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 983 nodes · 1671 edges · 129 communities (53 shown, 76 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 32 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d41dac96`
...
Cohesion: 0.12
Nodes (25): InsightsCache, MuscleInsightCards(), Props, RefreshCache, styles, todayKey(), AI_MODEL, AI_PROVIDER (+17 more)

### Community 15 - "firebase.ts"
Cohesion: 0.19
Nodes (11): updates, styles, SettingsAppScreen(), styles, url, styles, Toast(), ToastProps (+3 more)
...
### Community 23 - "expo-router"
Cohesion: 0.38
Nodes (3): TabLayout(), HapticTab(), expo-router

### Community 24 - "useAuth"
Cohesion: 0.17
Nodes (12): RootLayoutNav(), unstable_settings, SetSplitScreen(), SettingsAccountScreen(), SettingsScreen(), styles, styles, WorkoutsScreen() (+4 more)

### Community 26 - "timber-auth-shell.tsx"
Cohesion: 0.13
Nodes (18): SignInScreen(), styles, SignUpScreen(), styles, Slide, SLIDES, styles, styles (+10 more)

### Community 27 - "set-split.tsx"
Cohesion: 0.23
Nodes (9): styles, styles, chartConfig, styles, Dropdown(), DropdownProps, styles, SPLIT_OPTIONS (+1 more)
...
### Community 76 - "modal.tsx"
Cohesion: 0.06
Nodes (91): ActiveWorkoutScreen(), formatElapsed(), styles, WorkoutTimer(), AddWorkoutModal(), styles, PlannedWorkoutsScreen(), queueOrderCacheKey() (+83 more)

### Community 77 - "phone-auth.tsx"
Cohesion: 0.24
...
## Knowledge Gaps
- **419 isolated node(s):** `name`, `slug`, `version`, `orientation`, `icon` (+414 more)
