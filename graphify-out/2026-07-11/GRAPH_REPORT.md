# Graph Report - pump-pal  (2026-07-11)

## Corpus Check
- 113 files · ~72,654 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 770 nodes · 1306 edges · 68 communities (31 shown, 37 thin omitted)
...
Cohesion: 0.06
Nodes (90): ActiveWorkoutScreen(), blankRow(), blankSet(), EXERCISE_TYPES, formatElapsed(), styles, RootLayoutNav(), unstable_settings (+82 more)
...
Cohesion: 0.05
Nodes (41): backgroundColor, backgroundImage, foregroundImage, monochromeImage, adaptiveIcon, edgeToEdgeEnabled, package, predictiveBackGestureEnabled (+33 more)
...
Cohesion: 0.05
Nodes (43): dependencies, ai, @ai-sdk/google, expo, expo-constants, expo-file-system, expo-font, expo-haptics (+35 more)
...
Cohesion: 0.13
Nodes (19): buildTimeline(), ChallengeData, ChallengeDay, currentStreakLength(), formatDate(), formatTime(), isStreakAlive(), PushupChallengeScreen() (+11 more)
...
Cohesion: 0.11
Nodes (31): compareExerciseLabels(), ExercisePicker(), ExercisePickerProps, ExercisePickerSelection, Sheet, SheetHandle, SheetProps, styles (+23 more)
...
## Knowledge Gaps
- **362 isolated node(s):** `name`, `slug`, `version`, `orientation`, `icon` (+357 more)
