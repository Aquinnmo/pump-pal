...
## Corpus Check
- 151 files · ~107,577 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1211 nodes · 2184 edges · 136 communities (61 shown, 75 thin omitted)
...
## Communities (136 total, 75 thin omitted)
...
Cohesion: 0.09
Nodes (38): addExerciseToCatalog(), askChoice(), askMuscles(), askTrackingModes(), askVariation(), buildApprovedExercise(), buildVariation(), createPrompt() (+30 more)

### Community 14 - "useAuth"
Cohesion: 0.13
Nodes (19): RootLayoutNav(), unstable_settings, MuscleLoadScreen(), styles, SettingsAccountScreen(), styles, SettingsAppScreen(), styles (+11 more)

### Community 15 - "muscle-load.ts"
Cohesion: 0.06
Nodes (72): InsightsCache, MuscleInsightCards(), Props, RefreshCache, styles, todayKey(), LOAD_LEGEND_STEPS, MUSCLE_OPTIONS (+64 more)
...
Cohesion: 0.10
Nodes (33): DragHandle(), styles, compareExerciseLabels(), ExercisePicker(), ExercisePickerProps, ExercisePickerSelection, Sheet, SheetHandle (+25 more)
...
### Community 76 - "set-split.tsx"
Cohesion: 0.16
Nodes (13): Slide, SLIDES, styles, SetSplitScreen(), styles, styles, TimberAuthShell(), TimberAuthShellProps (+5 more)

### Community 77 - "modal.tsx"
Cohesion: 0.15
Nodes (20): styles, PlannedWorkoutsScreen(), queueOrderCacheKey(), styles, SettingsSplitScreen(), styles, Dropdown(), DropdownProps (+12 more)
...
Cohesion: 0.26
Nodes (15): ActiveWorkoutScreen(), formatElapsed(), styles, WorkoutTimer(), AddWorkoutModal(), formatAIError(), getOngoingInjuries(), getOngoingInjuryIds() (+7 more)
...
Cohesion: 0.17
Nodes (23): output, styles, WorkoutCard(), WorkoutCardProps, DraftExerciseRow, PerformedSet, Workout, buildPerformedExercise() (+15 more)

### Community 99 - "phone-auth.tsx"
Cohesion: 0.24
...
Cohesion: 0.38
Nodes (8): HomeScreen(), styles, Injury, applyInjuryToHistory(), injuryCoversDate(), predictNextWorkoutName(), predictWorkoutAfterName(), toDateObj()

### Community 118 - "sign-in.tsx"
Cohesion: 0.31
Nodes (7): SignInScreen(), styles, SignUpScreen(), styles, timberAuthStyles, FIREBASE_ERROR_MAP, getFriendlyAuthError()

### Community 121 - "use-draft-exercises.ts"
Cohesion: 0.31
Nodes (9): cascadeSetField(), DraftExerciseOptions, findLastPerformed(), useDraftExercises(), DraftSet, ExerciseType, PerformedExercise, collapseSetsToDraft() (+1 more)

### Community 129 - "expo-router"
Cohesion: 0.25
...
- **Why does `AddWorkoutModal()` connect `active-workout.tsx` to `settings-injuries.tsx`, `modal.tsx`, `useAuth`, `toDateObj`, `workout.ts`, `use-draft-exercises.ts`, `workout-conversion.ts`?**
