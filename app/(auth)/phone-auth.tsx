...
} from "@/components/firebase-recaptcha-modal";
import {
  TimberAuthShell,
  timberAuthStyles
            ...
            {step === 1 ? (
              <>
                ...
                <Text style={styles.hint}>
                  We detected your country code. We’ll text a code to get you
                  back to your log.
                </Text>

                <View style={styles.phoneRow}>
                  <View style={[timberAuthStyles.field, styles.callingCodeBox]}>
                ...
                {error ? (
                  <View
                    style={[timberAuthStyles.errorBanner, styles.errorBanner]}
                  >
                    <Ionicons
                      name="alert-circle"
                      size={16}
...
const styles = StyleSheet.create({
  ...
  // 24 is this screen's defining value, same exception as the muscle-load
  // percentage (docs/design-language.md).
  otpInput: {
    letterSpacing: 8,
    fontSize: 24,
    textAlign: "center",
