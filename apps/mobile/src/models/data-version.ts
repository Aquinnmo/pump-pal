...
//
// This counter is the "local rows changed" signal. src/models/sync-trigger.ts bumps it
...
// subscription work. Same shape as src/models/initial-sync.ts's gate listeners.
let version = 0;
