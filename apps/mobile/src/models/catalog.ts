...
// against node:sqlite (src/models/catalog.test.ts) the same way src/models/outbox.ts is.
// src/models/catalog-repository.ts binds this to the real
// native src/models/client.ts for app use.
//
