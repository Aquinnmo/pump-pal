...
// see src/models/sync-engine.test.ts. src/models/sync.ts binds this to the real src/models/client.ts
 ...
 * Caller (src/models/sync.ts) is responsible for: serializing runs per uid (one
...
export async function runSync(
  ...
  // is createKeyedMutex (src/models/sync.ts), which is an in-memory Map. A headless
