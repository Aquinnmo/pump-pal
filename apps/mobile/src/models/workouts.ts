...
// src/models/catalog.ts, src/models/outbox.ts for the same pattern) so it's testable against
// node:sqlite. src/models/workout-repository.ts binds this to src/models/client.ts for app
// use.
//
