// Raw typed HTTP calls for /api/workouts, against packages/contract/src/api-contract.ts.
// Used by web repositories (src/data/workout-repository.web.ts) directly
