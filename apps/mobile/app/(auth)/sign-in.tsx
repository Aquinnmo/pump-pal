...
// Set only by a personal-device iOS build, which signs with a generated bundle
// ID, so the published iOS Google OAuth client cannot work for it. Nothing in
// the repo sets this today — the installer script that did was removed; see
// IOS_NON_DEVELOPERS.md for the current manual flow.
