...
import { applyWearAction } from '@/utils/wear-state';
import { endSession, getSession, startSession, subscribe, updateSession } from '@/utils/active-workout-session';
...
function main() {
  ...
  console.log('utils/active-workout-session.test.ts: all assertions passed');
}
