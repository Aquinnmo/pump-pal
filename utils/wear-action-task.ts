import { getSession, updateSession } from '@/utils/active-workout-session';
import { buildWorkoutNotificationPresentation } from '@/utils/workout-notification-model';
import { ensureWorkoutChannel, showWorkoutNotification } from '@/utils/workout-notification';
import { applyWearAction, buildWearActiveState, WearAction } from '@/utils/wear-state';
...
// session (utils/active-workout-session.ts), so there is nothing left to reconcile
