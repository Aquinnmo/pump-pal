...
//
// This counter is the "local rows changed" signal. db/sync-trigger.ts bumps it
// after a run that actually pulled something; hooks/use-data-version.ts turns
...
// subscription work. Same shape as db/initial-sync.ts's gate listeners.
let version = 0;
